...
public final class ParamExtAck {
    ...
    public static ParamExtAck deserialize(ByteBuffer input) {
        ...
        EnumValue<ParamAck> paramResult = PayloadFieldDecoder.decodeEnum(io.dronefleet.mavlink.common.ParamAck.class, input, 1);
