...
public final class LandingTarget {
    ...
    public static LandingTarget deserialize(ByteBuffer input) {
        BigInteger timeUsec = PayloadFieldDecoder.decodeUint64(input);
        float angleX = PayloadFieldDecoder.decodeFloat(input);
        float angleY = PayloadFieldDecoder.decodeFloat(input);
        float distance = PayloadFieldDecoder.decodeFloat(input);
        float sizeX = PayloadFieldDecoder.decodeFloat(input);
        float sizeY = PayloadFieldDecoder.decodeFloat(input);
        int targetNum = PayloadFieldDecoder.decodeUint8(input);
        ...
        EnumValue<LandingTargetType> type = PayloadFieldDecoder.decodeEnum(io.dronefleet.mavlink.common.LandingTargetType.class, input, 1);
        int positionValid = PayloadFieldDecoder.decodeUint8(input);
