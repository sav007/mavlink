...
public final class Gps2Raw {
    ...
    public static Gps2Raw deserialize(ByteBuffer input) {
        ...
        long dgpsAge = PayloadFieldDecoder.decodeUint32(input);
        ...
        int dgpsNumch = PayloadFieldDecoder.decodeUint8(input);
