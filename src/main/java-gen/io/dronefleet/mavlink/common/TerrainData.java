...
public final class TerrainData {
    ...
    public static TerrainData deserialize(ByteBuffer input) {
        ...
        List<Integer> data = PayloadFieldDecoder.decodeInt16Array(input, 32);
        int gridbit = PayloadFieldDecoder.decodeUint8(input);
