...
public final class DataStream {
    ...
    public static DataStream deserialize(ByteBuffer input) {
        int messageRate = PayloadFieldDecoder.decodeUint16(input);
        int streamId = PayloadFieldDecoder.decodeUint8(input);
        int onOff = PayloadFieldDecoder.decodeUint8(input);
