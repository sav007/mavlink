...
public final class LogRequestList {
    ...
    public static LogRequestList deserialize(ByteBuffer input) {
        int start = PayloadFieldDecoder.decodeUint16(input);
        int end = PayloadFieldDecoder.decodeUint16(input);
